...
export function ChatPanel() {
  ...
  return (
    <div className="w-[400px] h-full flex flex-col bg-[#111118] border-l border-white/[0.06]">
      {/* Header */}
        ...
        {messages.length === 0 ? (
          <div className="flex flex-col items-center justify-center h-full text-center gap-4 opacity-40">
            ...
            <div>
              ...
              <p className="text-white/25 text-xs mt-1">Type a message or hold the mic</p>
            </div>
          </div>
        ) : (
          messages.map((msg, i) => (
        ...
        {loading && (
          <div className="flex justify-start msg-enter">
            <div className="flex gap-2">
              <div className="w-6 h-6 rounded-lg bg-emerald-500/20 text-emerald-300 flex items-center justify-center flex-shrink-0 mt-0.5">
                <Bot size={14} />
              </div>
      ...
      <div className="px-4 py-3 border-t border-white/[0.06]">
        <div className="flex items-center gap-2 bg-white/[0.04] border border-white/[0.08] rounded-2xl px-2 py-1.5 focus-within:border-indigo-500/30 transition-colors">
          {speechSupported && (
            <button
          ...
          <input
            ...
            className="flex-1 bg-transparent text-white text-sm placeholder-white/20 outline-none px-2 py-2"
